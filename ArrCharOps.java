...
public class ArrCharOps {
    public static void main(String[] args) {
        ...
        char[] arr3 = {'U','n','d','e','r','s','t', 'o', 'o', 'd'};
        System.out.println(str);  // Prints the string
        println(arr2);            // Prints an array of characters
        System.out.println(charAt(arr1,3));      
        System.out.println(indexOf(arr1,'y'));  
        System.out.println(indexOf(arr1,'l',3)); 
        System.out.println(lastIndexOf(arr1, 'l'));
        System.out.println(concat(arr1, arr3));
        System.out.println(subArray(arr3, 2, 9));
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        int length1 = (arr1.length + arr2.length);
        char[] con = new char[length1];
        for (int i = 0; i < arr1.length; i++){
            con[i] = arr1[i];
        }
        int index = 0;
        for (int i = arr1.length; i < length1; i++){
            con[i] = arr2[index];
            index++;
        }
        return con;
